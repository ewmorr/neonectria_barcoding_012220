...
## Consider separating this readme into intial/bioinformatic data processing, processing methods comparison, and ecological analyses worflows, with separate .mds for each
