...
rownames(site_cart_coords) = rownames(asv_tab.gtMin.rare)

mantel.correlog(
    D.eco = vegdist(log10(asv_tab.gtMin.rare+1), method = "bray"),
...
mantel(
xdis = vegdist(log10(asv_tab.gtMin.rare+1), method = "bray"),
...
scale_x_continuous(breaks = c(200,400,600,800,1000,1200,1400,1600), limits = c (200,1700)) +
my_gg_theme +
labs(x = "Distance (km)", y = "Mantel r")
#scale_color_manual

pdf("prelim_figs/mantel_correlogram.sites.pdf", width = 8, height = 4)
print(p1)
dev.off()
