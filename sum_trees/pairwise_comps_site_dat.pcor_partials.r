...
wax_precip_dbh = pcor(data.frame(pairwise_df$wax, pairwise_df$precip.winter, pairwise_df$dbh), method = "spearman")


wax_precip_dbh_lon = pcor(data.frame(pairwise_df$wax, pairwise_df$precip.winter, pairwise_df$dbh, pairwise_df$lon), method = "spearman")
