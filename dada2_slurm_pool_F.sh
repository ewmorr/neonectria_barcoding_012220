...
cd ~/GARNAS_neonectria_barcoding_runOneAndTwo_020320/run1_run2_files_cat_pool_F
mkdir dada2_processing_tables_figs
mkdir intermediate_RDS

srun Rscript ~/repo/neonectria_barcoding_012220/dada2-slurm_pool_F.r
...
cd ~/GARNAS_neonectria_barcoding_runOneAndTwo_020320/run1_run2_files_sep_pool_F
mkdir dada2_processing_tables_figs
mkdir intermediate_RDS

srun Rscript ~/repo/neonectria_barcoding_012220/dada2-slurm_files_sep_pool_F.r
srun Rscript ~/repo/neonectria_barcoding_012220/UNITE_taxonomic_classification-slurm.r
