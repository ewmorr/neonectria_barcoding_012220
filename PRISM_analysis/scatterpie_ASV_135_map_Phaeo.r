...
x = NULL,
y = NULL,
fill = expression(atop(italic("Phaeoacremonium sp."), "(proportion trees)"~phantom(100)))
...
legend.position = c(0.76,0.1775),
legend.title = element_text(size = 16, hjust = 0),
legend.text = element_text(size = 16)
)

pdf("PRISM_maps/ASV_135_occurence_in_sites.NEW.pdf", width = 6, height = 4)
p
dev.off()
