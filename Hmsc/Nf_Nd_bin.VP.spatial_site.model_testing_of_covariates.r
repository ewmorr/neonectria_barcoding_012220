...
#first running full set of vars (including wax and winter precip -- this could be probelmatic because they have 0.5 R^2)
...
VP = computeVariancePartitioning(m.spatial.full_covars, group = c(1,2,3,4,5,6,7,8,9), groupnames = c("intercept","GDD nongrowing", "freeze-thaw nongrowing", "duration infection", "DBH", "beech scale", "crown dieback", "total sequences"))
...
VP.vals.support$variable = factor(VP.vals.support$variable, levels = c("intercept","GDD nongrowing", "freeze-thaw nongrowing", "duration infection", "DBH", "beech scale", "crown dieback", "total sequencess"))
...
pdf("HMSC/Nf_Nd_variance_partitioning.bin.spatial.pdf", width = 8, height = 6)
p1
dev.off()
