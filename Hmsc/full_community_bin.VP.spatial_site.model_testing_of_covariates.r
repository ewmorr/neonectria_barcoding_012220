...
#first running full set of vars (including wax and excluding winter precip)
...
pdf("HMSC/full_com_variance_partitioning.bin.spatial.pdf", width = 24, height = 6)
p1
dev.off()
...
pdf("HMSC/full_com_spp_associations.bin.spatial.pdf", width = 16, height = 16)
corrplot(toPlot, method = "color",
col=colorRampPalette(c("blue","white","red"))(500),
tl.cex=.6, tl.col="black",
title=paste("random effect level:", m.spatial$rLNames[1]), mar=c(0,0,1,0))
