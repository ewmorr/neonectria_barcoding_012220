...
#winter andsummer precip. and precip. are not correlated so can run all vars together
XData = full_metadata.sorted %>% dplyr::select("ppt.mean_nongrowing", "ppt.mean_growing", "total_seqs")
...
VP = computeVariancePartitioning(m.spatial.full_covars, group = c(1,2,3,4), groupnames = c("intercept","precip. nongrowing", "precip. growing", "total sequences"))
...
VP.vals$variable = c("intercept","precip. nongrowing", "precip. growing", "total sequences")
...
postBeta.mean$variable = c("intercept","precip. nongrowing", "precip. growing", "total sequences")
...
postBeta.support$variable = c("intercept","precip. nongrowing", "precip. growing", "total sequences")
...
postBeta.supportNeg$variable = c("intercept","precip. nongrowing", "precip. growing", "total sequences")
...
VP.vals.support$variable = factor(VP.vals.support$variable, levels = c("intercept","precip. nongrowing", "precip. growing", "total sequences"))
...
pdf("HMSC/Nf_Nd_variance_partitioning.nongrowing_v_growing_precip..bin.spatial.pdf", width = 8, height = 6)
p1
dev.off()
