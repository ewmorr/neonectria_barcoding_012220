...
XData = full_metadata.sorted %>% dplyr::select("total_seqs")
...
VP = computeVariancePartitioning(m.spatial.full_covars, group = c(1,2), groupnames = c("intercept","total sequences"))
...
VP.vals = VP.vals[1:2,] #this removes the random effect

VP.vals$variable = c("intercept","total sequences")
...
postBeta.mean$variable = c("intercept","total sequences")
...
postBeta.support$variable = c("intercept","total sequences")
...
postBeta.supportNeg$variable = c("intercept","total sequences")
...
VP.vals.support$variable = factor(VP.vals.support$variable, levels = c("intercept","total sequences"))
