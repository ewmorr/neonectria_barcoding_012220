...
Ytable = cbind(Ytable, asv_tab.gt1K.asv_19)
...
colnames(VP.vals) = c("Nf", "Nd", "ASV_19")
...
colnames(postBeta.mean) = c("Nf", "Nd", "ASV_19")
...
colnames(postBeta.support) = c("Nf", "Nd", "ASV_19")
...
colnames(postBeta.supportNeg) = c("Nf", "Nd", "ASV_19")
...
VP.vals.support[VP.vals.support["ASV"] == "ASV_19", "ASV"] = "F. babinda"
...
pdf("HMSC/Nf_Nd_ASV19_variance_partitioning.bin.spatial.pdf", width = 10, height = 6)
p1
dev.off()
