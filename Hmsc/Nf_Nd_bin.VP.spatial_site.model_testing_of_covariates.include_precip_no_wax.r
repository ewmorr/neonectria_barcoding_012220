...
XData = full_metadata.sorted %>% dplyr::select("HDD4.mean_nongrowing", "freezeThaw.mean_nongrowing", "ppt.mean_nongrowing", "duration_infection", "dbh", "TreeCond", "total_seqs")
...
VP = computeVariancePartitioning(m.spatial.full_covars, group = c(1,2,3,4,5,6,7,8), groupnames = c("intercept","GDD nongrowing", "freeze-thaw nongrowing", "precip. nongrowing", "duration infection", "DBH", "crown dieback", "total sequences"))
...
VP.vals$variable = c("intercept","GDD nongrowing", "freeze-thaw nongrowing", "precip. nongrowing", "duration infection", "DBH", "crown dieback", "total sequences")
...
postBeta.mean$variable = c("intercept","GDD nongrowing", "freeze-thaw nongrowing", "precip. nongrowing", "duration infection", "DBH", "crown dieback", "total sequences")
...
postBeta.support$variable = c("intercept","GDD nongrowing", "freeze-thaw nongrowing", "precip. nongrowing", "duration infection", "DBH", "crown dieback", "total sequences")
...
postBeta.supportNeg$variable = c("intercept","GDD nongrowing", "freeze-thaw nongrowing", "precip. nongrowing", "duration infection", "DBH", "crown dieback", "total sequences")
...
VP.vals.support$variable = factor(VP.vals.support$variable, levels = c("intercept","GDD nongrowing", "freeze-thaw nongrowing", "precip. nongrowing", "duration infection", "DBH", "crown dieback", "total sequences"))
...
pdf("HMSC/Nf_Nd_variance_partitioning.bin.spatial.with_precip_no_wax.pdf", width = 8, height = 6)
p1
dev.off()
