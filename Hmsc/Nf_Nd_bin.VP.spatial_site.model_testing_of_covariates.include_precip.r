...
VP = computeVariancePartitioning(m.spatial.full_covars, group = c(1,2,3,4,5,6,7,8,9), groupnames = c("intercept","GDD nongrowing", "freeze-thaw nongrowing", "precip. non-growing", "duration infection", "DBH", "beech scale", "crown dieback", "total sequences"))
...
VP.vals$variable = c("intercept","GDD nongrowing", "freeze-thaw nongrowing", "precip. non-growing", "duration infection", "DBH", "beech scale", "crown dieback", "total sequences")
...
postBeta.mean$variable = c("intercept","GDD nongrowing", "freeze-thaw nongrowing", "precip. non-growing", "duration infection", "DBH", "beech scale", "crown dieback", "total sequences")
...
postBeta.support$variable = c("intercept","GDD nongrowing", "freeze-thaw nongrowing", "precip. non-growing", "duration infection", "DBH", "beech scale", "crown dieback", "total sequences")
...
postBeta.supportNeg$variable = c("intercept","GDD nongrowing", "freeze-thaw nongrowing", "precip. non-growing", "duration infection", "DBH", "beech scale", "crown dieback", "total sequences")
...
VP.vals.support$variable = factor(VP.vals.support$variable, levels = c("intercept","GDD nongrowing", "freeze-thaw nongrowing", "precip. non-growing", "duration infection", "DBH", "beech scale", "crown dieback", "total sequences"))
