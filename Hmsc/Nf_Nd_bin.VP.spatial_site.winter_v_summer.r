...
XData = full_metadata.sorted %>% dplyr::select("HDD4.mean_nongrowing", "freezeThaw.mean_nongrowing","HDD4.mean_growing", "freezeThaw.mean_growing", "total_seqs")
...
VP = computeVariancePartitioning(m.spatial.full_covars, group = c(1,2,3,4,5,6), groupnames = c("intercept","GDD nongrowing", "freeze-thaw nongrowing", "GDD growing", "freeze-thaw growing","total sequences"))
...
VP.vals = VP.vals[1:6,] #this removes the random effect
...
VP.vals$variable = c("intercept","GDD nongrowing", "freeze-thaw nongrowing", "GDD growing", "freeze-thaw growing","total sequences")
...
postBeta.mean$variable = c("intercept","GDD nongrowing", "freeze-thaw nongrowing", "GDD growing", "freeze-thaw growing","total sequences")
...
postBeta.support$variable = c("intercept","GDD nongrowing", "freeze-thaw nongrowing", "GDD growing", "freeze-thaw growing","total sequences")
...
postBeta.supportNeg$variable = c("intercept","GDD nongrowing", "freeze-thaw nongrowing", "GDD growing", "freeze-thaw growing","total sequences")
...
VP.vals.support$variable = factor(VP.vals.support$variable, levels = c("intercept","GDD nongrowing", "freeze-thaw nongrowing", "GDD growing", "freeze-thaw growing","total sequences"))
...
pdf("HMSC/Nf_Nd_variance_partitioning.nongrowing_v_growing.GDD_freeze-thaw.bin.spatial.mod.pdf", width = 8.5, height = 7)
p1
dev.off()


write.table(VP.vals.support, "Nf_Nd_variance_partitioning.bin.spatial.winter_v_summer.VP_table.txt", row.names = F, sep = "\t", quote = F)
