...
VP = computeVariancePartitioning(m.spatial.full_covars, group = c(1,2,3,4), groupnames = c("intercept","GDD nongrowing", "GDD growing", "total sequences"))
...
postBeta.mean$variable = c("intercept","GDD nongrowing", "GDD growing", "total sequences")
...
postBeta.support$variable = c("intercept","GDD nongrowing", "GDD growing", "total sequences")
...
postBeta.supportNeg$variable = c("intercept","GDD nongrowing", "GDD growing", "total sequences")
...
VP.vals.support$variable = factor(VP.vals.support$variable, levels = c("intercept","GDD nongrowing", "GDD growing", "total sequences"))
