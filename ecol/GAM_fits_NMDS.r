...
pdf("prelim_figs/NMDS_neo_occurence_by_climate_1Kmin_GAM.pdf", width = 22, height = 12)
grid.arrange(p.site,p.dur_inf,p.tmin,p.MAT,p.tmax,p.ppt,nrow = 2)
dev.off()

pdf("prelim_figs/NMDS_neo_occurence_by_disease_severity_1Kmin_GAM.pdf", width = 22, height = 18)
