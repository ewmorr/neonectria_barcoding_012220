...
saveRDS(asv_tab.gt1K.rare, file = "intermediate_RDS/asv_tab.gt1K.rare.rds")
...
saveRDS(asv_tab.gt1K.rare.mds, file = "intermediate_RDS/asv_tab.gt1K.rare.mds.rds")
...
saveRDS(asv_tab.gt5K.rare, file = "intermediate_RDS/asv_tab.gt5K.rare.rds")
...
saveRDS(asv_tab.gt5K.rare.mds, file = "intermediate_RDS/asv_tab.gt5K.rare.mds.rds")
...
saveRDS(asv_tab.gt1K.rare.mds.bin, file = "intermediate_RDS/asv_tab.gt1K.rare.mds.bin.rds")
...
saveRDS(asv_tab.gt5K.rare.mds.bin, file = "intermediate_RDS/asv_tab.gt5K.rare.mds.bin.rds")
